        ...
        <div class="col-sm-2">
          <select class="form-control" name="cbo_1" id="cbo_1"  style="">
              ...
              <?php //foreach($lista_categorias as $i=>$lis):
                    ...
                    <option value="PAS" <?php if(@$cbo_1 == 'PAS') echo 'selected'; ?>>PASPORTE</option>
                    <option value="DNI" <?php if(@$cbo_1 == 'DNI') echo 'selected'; ?>>DNI</option>
                    <option value="RUC" <?php if(@$cbo_1 == 'RUC') echo 'selected'; ?>>RUC</option>
          </select>
        </div>
        <div class="col-sm-2">
