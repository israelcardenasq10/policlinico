        ...
        <div class="form-horizontal">
              <form action="#" method="post" enctype="multipart/form-data" name="frm1" id="frm1">
                <input type="hidden" class="id_mod" id="id" name="id">
                  ...
                  <div class="col-md-12">
                      <h2><span class="fa fa-edit fa-1x"></span> Editar <?=ucwords($module_id)?> <?=ucwords($p_categoria)?></h2>   
                      <h5>Actualice la informacion de <?=ucwords($module_id)?> <?=ucwords($p_categoria)?></h5>
                      <hr/>
                  </div>      
                  <div class="col-md-12" id="form">                       
                      <div class="form-group">
                          <div class="col-md-2"></div>
                           <div class="col-md-2">
                              <!-- <label>Prefijo</label> -->
                              <input type="text" class="form-control" name="id_cat" id="id_cat" maxlength="2" value="" placeholder="Codigo" style="text-transform: uppercase;" required>
                           </div> 
                           <div class="col-md-4">
                              <!-- <label>Categoria</label> -->
                              <input type="text" class="form-control" style="text-transform: capitalize;" name="nombre" id="nombre" value="" placeholder="Categoria" required>
                          </div>
                          <div class="col-md-1">
                              <!-- <label>&nbsp;</label><br /> -->
                              <input type="hidden" name="hdpagina" id="hdpagina" value="<?=$p_categoria?>">
