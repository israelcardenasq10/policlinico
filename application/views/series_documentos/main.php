                ...
                <div id="signupbox" class="mainbox col-md-10">
                        <div class="form-horizontal">
                              <form action="#" method="post" enctype="multipart/form-data" name="frm1" id="frm1">
                                <input type="hidden" class="id_mod" id="id_serie" name="id_serie">
                                  ...
                                  <div class="col-md-12" id="form">                       
                                      <div class="form-group">
                                          <div class="col-md-2">
                                          <input type="text" class="form-control" name="local" id="local" value="" placeholder="Local" required>
                                          </div>
                                          <div class="col-md-1">
                                              <input type="text" class="form-control" name="serie" id="serie" value="" placeholder="Serie" required>
                                          </div> 
                                          <div class="col-md-2">
                                              <input type="text" class="form-control" style="text-transform: uppercase;" name="tdoc" id="tdoc" value="" placeholder="Tipo Doc" maxlength="2" required>
                                          </div>
                                          <div class="col-md-3">
                                              <input type="text" class="form-control" style="text-transform: capitalize;" name="descripcion" id="descripcion" value="" placeholder="Nombre Documento" required>
                                          </div>
                                          <div class="col-md-2">
                                              <input type="text" class="form-control" style="text-transform: uppercase;" name="tipo_doc" id="tipo_doc" value="" placeholder="Desc" maxlength="4" required>
                                          </div>
                                          <div class="col-md-1">
                                  ...
                                  <tbody>
                                    <?php foreach($lista as $i=>$lis): ?>
                                            <tr id="service<?=$lis->id_serie?>">
                                              <td>
                                                <button class="btn btn-<?=$a_btn_class_mod?> btn-sm" style="<?=$a_btn_disabled_mod?>" onclick="<?=$evento_mod?>(this.id, 'ver<?=$p_modulo?>');" id="<?=$lis->id_serie?>"><span class="glyphicon glyphicon-pencil"></span></button>
                                                <!-- <button class="btn btn-<?=$a_btn_class_eli?> btn-sm" style="<?=$a_btn_disabled_eli?>" onclick="<?=$evento_eli?>(this.id, 'eliminar<?=$p_modulo?>');" id="<?=$lis->id_serie?>"><span class="glyphicon glyphicon-remove"></span></button> -->
                                              </td>
                                              <td><?=$lis->local?></td>
                                              <td><?=$lis->serie?></td>
                                              <td><?=$lis->tdoc?></td>                                              
